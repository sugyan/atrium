...
use atrium_api::app::bsky::actor::get_profile::GetProfile;
use atrium_api::app::bsky::feed::get_timeline::GetTimeline;
use atrium_api::com::atproto::server::create_session::CreateSession;
...
impl GetSession for XrpcReqwestClient {}
