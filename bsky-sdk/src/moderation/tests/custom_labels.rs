...
use super::{ModerationTestResultFlag, TestExpectedBehaviors};
...
#[derive(Debug)]
struct CustomLabelTestScenario {
    blurs: LabelValueDefinitionBlurs,
    severity: LabelValueDefinitionSeverity,
    account: TestExpectedBehaviors,
    profile: TestExpectedBehaviors,
    post: TestExpectedBehaviors,
}
